...
namespace TrainerManagementApp.Tests.TestCases
{
    public class BoundaryTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Add_Trainer_NotNull()
        {
            //Arrange
            var res = false;
            ...
            try
            {
                trainerservice.Setup(repos => repos.Add()).Returns("");
                var result = _trainerService.Add();
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Trainer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                trainerservice.Setup(repos => repos.Delete()).Returns("");
                var result = _trainerService.Delete();
        ...
        [Fact]
        public async Task<bool> Testfor_UpdateTrainer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_GetByIdTrainer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_AddTrainer_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_DeleteTrainer_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
